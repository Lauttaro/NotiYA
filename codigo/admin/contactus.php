...
if($query)
{
$msg="Sobre la pagina actualizado correctamente";
}
else{
$error="Algo ocurrio, intentalo nuevamente";    
} 
...
<html lang="en">
    <head>
        ...
        <title>NotiYA | Pagina de contacto</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Pagina de Contacto  </h4>
