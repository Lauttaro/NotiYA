...
$msg="Contrasena Cambiada correctamente!!";
}
}
else
{
$error="La anterior contrasena es erronea!!";
}
}
...
<html lang="en">
    <head>
        ...
        <title>NotiYA| Agregar Categoria</title>
...
{
alert("La contrasena actual esta vacia!!");
document.chngpwd.password.focus();
return false;
}
else if(document.chngpwd.newpassword.value=="")
{
alert("La nueva contrase;a esta vacia!!");
document.chngpwd.newpassword.focus();
return false;
}
else if(document.chngpwd.confirmpassword.value=="")
{
alert("la confirmacion de contrasena esta vacia!!");
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Cambiar Contrasena</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Cambiar Contrasena</b></h4>
                                    <hr />
...
<label class="col-md-4 control-label">Contrasena Actual</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="col-md-4 control-label">Nueva contrasena</label>
<div class="col-md-8">
